...
type OperatorOptions[IN1, IN2, OUT any] struct {
	...
	New         component2.NewOperator[IN1, IN2, OUT]
	Channel     bool
	ChannelSize uint
}
...
type OperatorTask[IN1, IN2, OUT any] struct {
	...
	operator             component2.Operator[IN1, IN2, OUT]
...
func (o *OperatorTask[IN1, IN2, OUT]) Daemon() error {
	...
	if err := safe.Run(func() error {
		return o.operator.Open(component2.NewContext(o.ctx, o.Name()),
			element2.Collector[OUT]{Meta: o.elementMeta, EmitNext: o.emitNext})
	}); err != nil {
...
func (o *OperatorTask[IN1, IN2, OUT]) Emit1(e1 element2.Element[IN1]) {
	o.synchronousProcessor.ProcessElement1(e1)
}
func (o *OperatorTask[IN1, IN2, OUT]) Emit2(e2 element2.Element[IN2]) {
	o.synchronousProcessor.ProcessElement2(e2)
}

// -------------------------------------ElementHandler---------------------------------------------

func (o *OperatorTask[IN1, IN2, OUT]) OnElement1(e1 element2.Element[IN1]) {
	switch e1.Type() {
...
func (o *OperatorTask[IN1, IN2, OUT]) OnElement2(e2 element2.Element[IN2]) {
	switch e2.Type() {
	case element2.EventElement:
...
func (o *OperatorTask[IN1, IN2, OUT]) TriggerBarrier(detail barrier.Detail) {
	o.emitNext(&element2.Barrier[OUT]{Meta: o.elementMeta, Detail: detail})
	message := barrier.ACK
	safe.Go(func() error {
...
func NewOperatorTask[IN1, IN2, OUT any](ctx _c.Context, options OperatorOptions[IN1, IN2, OUT], emitNext element2.EmitNext[OUT]) *OperatorTask[IN1, IN2, OUT] {
